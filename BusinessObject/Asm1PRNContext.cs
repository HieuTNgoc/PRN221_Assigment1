...
{
    public partial class Asm1PRNContext : DbContext
    {
        public Asm1PRNContext()
        {
        }

        public Asm1PRNContext(DbContextOptions<Asm1PRNContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ProductId })
                    .HasName("PK__OrderDet__08D097A3AB2D166D");
